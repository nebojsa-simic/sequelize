...
module.exports = (function() {
  var DAOFactory = function(name, attributes, options) {
    ...
    if (this.options.hasOwnProperty("translatable") && this.options.translatable.length) {
      this.options.classMethods["setDefaultLocale"] = function (defLocale) {
        this.options.defaultLocale = defLocale;
      };
      this.options.classMethods["getDefaultLocale"] = function () {
  ...
  Object.defineProperty(DAOFactory.prototype, 'localeAttributes', {
    get: function() {
      return this.QueryGenerator.attributesToSQL(this.rawLocaleAttributes)
    }
  })
  ...
  DAOFactory.prototype.init = function(daoFactoryManager) {
    ...
    if (this.options.hasOwnProperty("translatable") && this.options.translatable.length) {
      ...
      Utils._.each(this.rawAttributes, function (options, attribute) {
        var isTranslatableAttribute = Utils._.indexOf(this.options.translatable, attribute) !== -1;
      ...
      this.rawLocaleAttributes["locale"] = {
        ...
        defaultValue: this.options.defaultLocale 
      };

      this.rawAttributes = this.rawBaseAttributes;
    } 
  ...
  DAOFactory.prototype.sync = function(options) {
    ...
    return new Utils.CustomEventEmitter(function(emitter) {
      var doQuery = function() {
        var isTranslatable = options.hasOwnProperty("translatable") && options.translatable.length;
        self
          .QueryInterface
          ...
          .success(function() {
            if (isTranslatable) {
              self
                .QueryInterface
                .createTable(self.getTableName() + "_locale", self.localeAttributes, options)
                .proxy(emitter, {events: ['error', 'sql']})
                .success(function() {
