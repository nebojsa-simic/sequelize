var Utils       = require("./utils")
  ...
  , DAOTranslatable = require('./dao-translatable')
...
module.exports = (function() {
  var DAOFactory = function(name, attributes, options) {
    ...
    if (this.options.translatable.length) {
      this.translatable = new DAOTranslatable(this);
    }
  ...
  Object.defineProperty(DAOFactory.prototype, 'localeAttributes', {
    get: function() {
      return this.translatable.localeAttributes;
    }
  })
 ...
 ;(function() {
  ...
  DAOFactory.prototype.init = function(daoFactoryManager) {
    ...
    // split attributes into base and translatable 
    this._hasTranslatableAttributes = this.options.translatable.length && this.options.translatable.length > 0;
    if (this._hasTranslatableAttributes) {
      this.translatable.initAttributes();
    } 
    ...
    if (this._hasTranslatableAttributes) {
      this.translatable.refreshAttributes();
    }
    ...
    if (this._hasTranslatableAttributes) { 
        this.translatable.initBooleanDateAndDefaultValues();
    }
  ...
  DAOFactory.prototype.refreshAttributes = function() {
    ...
    this.DAO.prototype._hasCustomGetters = this.DAO.prototype._hasCustomGetters || Object.keys(this.DAO.prototype._customGetters).length
    this.DAO.prototype._hasCustomSetters = this.DAO.prototype._hasCustomSetters || Object.keys(this.DAO.prototype._customSetters).length

    Object.defineProperties(this.DAO.prototype, attributeManipulation)
    this.DAO.prototype.rawAttributes = Utils._.assign(this.DAO.prototype.rawAttributes || {}, this.rawAttributes);
    this.DAO.prototype.attributes = (this.DAO.prototype.attributes || []).concat(Object.keys(this.DAO.prototype.rawAttributes))
    ...
    return new Utils.CustomEventEmitter(function(emitter) {
      var doQuery = function() {
        self
          ...
          .success(function() {
            if (self._hasTranslatableAttributes) {
              self.translatable.sync(options, emitter);
            } else {
  ...
  */
  ...
  DAOFactory.prototype.create = function(values, fieldsOrOptions) {
    ...
    createdDao = this.build(values, {
        isNewRecord: true
      }).save(fieldsOrOptions); 

    if (this._hasTranslatableAttributes) {
      createdDao = this.translatable.create(values, fieldsOrOptions, createdDao);
    } 
